        ...
        {/* NEWS + FOOTER */}
            <Row className="rounded">
              <div className="rounded bg-white pt-3">
                <Row>
                  <Col><p className="fw-bold mb-1">LinkedIn News</p></Col>
                  <Col className="text-end"><p><BsFillInfoSquareFill /></p></Col>            
                </Row> 
                <ul>
                  <li>
                    <p className="fw-bold m-0">Scientists Discover That Coffee is the Real Source of Renewable Energy!</p>
                    <p className="text-secondary mb-1">Main news &middot; 331 readers</p>
                  </li>
                  <li>
                    <p className="fw-bold m-0">Local Cat Declares War on Vacuum Cleaner: Demands Peace Talks</p>
                    <p className="text-secondary mb-1">1 day ago</p>
                  </li>
                  <li>
                    <p className="fw-bold m-0">Breaking News: World's Slowest Snail Sets New Speed Record</p>
                    <p className="text-secondary mb-1">4 days ago</p>
                  </li>
                  <li>
                    <p className="fw-bold m-0">Aliens Abduct Entire Pizza Delivery Fleet - Demands Earth's Best Recipes</p>
                    <p className="text-secondary mb-1">19 hours ago</p>
                  </li>
                  <li>
                    <p className="fw-bold m-0">Exclusive Interview with Sock: 'Where Do All the Missing Pairs Go?</p>
                    <p className="text-secondary mb-1">2 days ago</p>
                  </li>
                </ul>
                <p className="text-secondary">Show more <IoIosArrowDown /></p>
              </div>
              <img
